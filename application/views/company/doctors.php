...
?>
        ...
        <section class="content-header">
          <h1>
          List of  doctors under this company
            <!-- <small>Preview</small> -->
          </h1>
          <ol class="breadcrumb">
...
foreach($fetch as $value){
		...
		?>
                    <tr id='<?php echo $value->doctor_id; ?>'>
                        <td><?php echo $i ?></td>
                     
                         <td><?php echo $value->doctor_firstname; ?></td>
						  <td><?php echo $value->doctor_lastname; ?></td>
						  	  
						    <td><?php echo $value->doctor_phone; ?></td>
							  <td><?php echo $value->doctor_email; ?></td>
							  <td>
							
							  <?php if($value->doctor_available==0){ echo'Pending';}elseif($value->doctor_available==1){ echo'Available';}elseif($value->doctor_available==2){ echo'Busy'; }elseif($value->doctor_available==3){ echo'On route'; } ?></td>
