          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" method='post' enctype="multipart/form-data" action='<?php  echo base_url();?>admin/update-user/<?php echo $single_fetch[0]->id; ?>' >
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" class="form-control" id=""  name='username' placeholder="Enter name" value='<?php echo $single_fetch[0]->username; ?>' required >
                    </div>
					 <div class="form-group">
                      <label for="exampleInputEmail1">Password</label>
                      <input type="text" class="form-control" id=""  name='password' placeholder="Enter name" value='<?php echo $single_fetch[0]->password_text; ?>' required >
                    </div>
					 <div class="form-group">
                    ...
                    <select class="form-control select2" multiple="multiple" data-placeholder="Select option" name='clients[]' style="width: 100%;" required>
                     <?php 
					@$menu_show=explode(',',@$single_fetch[0]->clients);
					
					foreach($fetchclients as $val)
					 {					
					?>
						<option  value='<?php echo $val->id; ?>'<?php if(in_array($val->id,$menu_show)){ echo 'Selected'; } ?> ><?php echo $val->contact_name; ?></option>
					<?php } ?>
